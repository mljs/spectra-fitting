 ...
 * @param {Object} input - A object containing the x and y data to be fitted.
 * @param {Array} group - A list of initial parameters to be optimized comming from a peak picking {x, y, width}.
